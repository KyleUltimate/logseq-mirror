...
- # Little Notes
	  ...
	  collapsed:: true
		- words ending with -de
		  collapsed:: true
			...
			- persuade -> persuasion
			- invade -> invasion
	- ## "Important" Synonyms(ECVFS) #card #incremental
	...
	- ## the abroad family
	  collapsed:: true
		...
		- board -> 板子
		- broad -> 寬廣
	- ## Ways to say "way"(3MA) #card #incremental
	...
	- ## Amazing Synonyms (SAMFFS) #card #incremental
