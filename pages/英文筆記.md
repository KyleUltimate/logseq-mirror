...
- # Little Notes
	  ...
	  collapsed:: true
		- words ending with -de
		  collapsed:: true
			...
			- persuade -> persuasion
			- invade -> invasion
	- ## "Important" Synonyms( {{cloze ECVFS}} ) #card #incremental
	...
	- ## the abroad family
	  collapsed:: true
		...
		- board -> 板子
		- broad -> 寬廣
	- ## Ways to say "way"( {{cloze 3MA}} ) #card #incremental
	...
	- ## Amazing Synonyms ( {{cloze SAMFFS}} ) #card #incremental
...
- # Conjunctions
	- ## 並且 ( {{cloze MABAF}} ) #card #incremental
	  ...
	  collapsed:: true
		...
		- **A**dditional
		- **F**urthermore
	- ## 因此 ( {{cloze CTTSH}} ) #card #incremental
