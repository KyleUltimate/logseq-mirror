...
- # 為什麼要在乎我的意見？
	...
	- 對於 LogLog 的文章，一個常見的回應是 「Rust 並非對那種用途所設計」。當然，如果在上增加了一套正確的程式語言，你或許可以以更快發布遊戲，但為什麼我們不能嘗試讓 Rust 成為對下一代的電漿工程師、生科研究生、或 AI 工程師的那個 「恰恰好」的程式語言呢？就算 Typescript 有著比 Rust 2 成高的 UI 設計時間，但
-
- # 常見翻譯問題
