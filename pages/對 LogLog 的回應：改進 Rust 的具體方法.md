...
- # 為什麼要我的意見你要在乎？
	...
	- 對於我而言，Rust 應該要能進步到使他能在不論哪一種使用方法下都能不錯的狀態 —— 我不願放棄。我希望在我這世代，而不是下一代，那萬能的程式語言即能發展出來。為什麼要把 Rusfmt 、 Rustdoc 和 Cargo 這些了不起的專案拋棄呢？在這世界上，我們有實際的問題要解決，沒有時間再等 *另* 一個程式語言
