...
- # 為什麼要在乎我的意見
	...
	- 在 Rust 之前，我對全端皆有接觸，從 Python, C, CUDA 和 JavaScript 都有涉獵。我不但有在昂貴的超級計算集群上處理偏微分方程，還有處理那殘破不堪的 Python 安裝環境，那沒一次安裝成功的 CUDA 驅動，那跟鬼一樣的 C 編譯環境，最後處理 JavaScript 那荒謬的生態系